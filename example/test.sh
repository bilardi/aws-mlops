...
AWS_PROFILE=$AWS_PROFILE AWS_REGION=$AWS_REGION bash test_docker.sh pretraining
AWS_PROFILE=$AWS_PROFILE AWS_REGION=$AWS_REGION bash test_docker.sh testing

AWS_PROFILE=$AWS_PROFILE AWS_REGION=$AWS_REGION bash test_docker.sh preinference
